  ...
  useEffect(() => {
    ...
    const onWheel = (e) => {
      ...
      if (next === scaleRef.current) {
        ...
        const notBusy  = !snapAnimRef.current?.isActive() && !scaleAnimRef.current?.isActive();

        if ((atMax || atMin) && notBusy) {

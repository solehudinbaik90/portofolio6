...
const CLIENTS = [
  ...
  'O2 Business','Sabato Studio','Sarmayacar','Sir Elton John','UNESCO','Volkswagen',
];
const INDUSTRIES = [
  'Agency / Studio','AR/VR/XR','Artificial Intelligence','E-Commerce','Aviation',
  'Culture','Entertainment','Fashion','Finance','Telecommunication','Venture Capital',
];
const RECOGNITION = [
  'Awwwards','Forbes',"It's Nice That",'LogoArchive','TEDx','UNICEF','Rolling Stone',
];
  ...
  return (
    ...
    >
      <path
        ...
        fill="#FFBF00" stroke="#FFBF00" strokeWidth="2"
...
function IconTools() {
  return (
    ...
    >
      ...
      <path d="M16 8L12 12Z" fill="#FD011B" />
      <path
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-[112px] top-[112px] z-20 flex justify-center px-4">
      ...
      >
        <div className="custom-scrollbar flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
          ...
          <div className={`flex items-start justify-between gap-3 ${divider}`}>
            <div className="flex items-center gap-3">
              <img
                src="/headshot.png" alt="Hamza Tariq"
          ...
          <div className={`flex items-start gap-2 ${divider}`}>
            {[
              ...
              >
                <span className="text-[20px] leading-none text-white">{lbl}</span>
              </div>
            ))}
          </div>
          ...
          <div className={`flex flex-col gap-1 ${divider}`}>
            ...
            <div className="flex flex-col">
              <p className={body}>
                AI is reshaping how we all work (—) and how the world creates and
                consumes. I'm leaning into it, adapting my workflows to stay nimble,
                while staying thoughtful about where the lines should sit: what we
                think through ourselves, what we hand off, and how we iterate.
              </p>
              <p className={muted}>
                This very website is a small example: designed entirely in Figma and
                Paper, then developed with Claude and a careful round of manual
                adjustments in VS Code.
              </p>
            </div>
          </div>
          ...
          <div className={`flex items-start gap-1 ${divider}`}>
            ...
            <img
              src="/media/info/now-listening.png" alt="" draggable={false}
          ...
          <div className={`flex items-start gap-1 ${divider}`}>
            ...
            <img
              src="/media/info/now-reading.png" alt="" draggable={false}
              className="size-8 shrink-0 rotate-[-5deg] rounded-[4px] object-cover"
            />
          </div>
        ...
        <div aria-hidden className="pointer-events-none absolute inset-x-0 bottom-0 h-16">
          ...
          <div
            className="absolute inset-0"
            style={{ background: 'linear-gradient(transparent 0%, transparent 100%)' }}
          />
        </div>
      </div>
    </div>
